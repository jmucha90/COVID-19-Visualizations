...
uscase_death = pd.DataFrame({'Date':data_us['dateRep'], 'Total Cases':unitedstatesdata['cases'], 'Total Deaths':unitedstatesdata['deaths']})
italycase_death = pd.DataFrame({'Date':data_italy['dateRep'], 'Total Cases':italydata['cases'], 'Total Deaths':italydata['deaths']})
spaincase_death = pd.DataFrame({'Date':data_spain['dateRep'], 'Total Cases':spaindata['cases'], 'Total Deaths':spaindata['deaths']})
ukcase_death = pd.DataFrame({'Date':data_uk['dateRep'], 'Total Cases':ukdata['cases'], 'Total Deaths':ukdata['deaths']})
polandcase_death = pd.DataFrame({'Date':data_poland['dateRep'], 'Total Cases':polanddata['cases'], 'Total Deaths':polanddata['deaths']})
chinacase_death = pd.DataFrame({'Date':data_china['dateRep'], 'Total Cases':chinadata['cases'], 'Total Deaths':chinadata['deaths']})
skcase_death = pd.DataFrame({'Date':data_sk['dateRep'], 'Total Cases':SK_data['cases'], 'Total Deaths':SK_data['deaths']})
